...
router.delete("/variant/delete/:id",   adminController.delete_variant_by_id)
...
router.delete("/fabric/master/delete/:id",   adminController.delete_fabric_master_by_id)
...
router.delete("/collar/master/delete/:id",   adminController.delete_collar_master_by_id)
...
router.delete("/button/master/delete/:id",   adminController.delete_button_master_by_id)
